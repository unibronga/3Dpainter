...
Рабочая версия 0.6.0. Новое в 0.6.0: меню **Эффекты** с видами пиксель-арт
и аниме (cel-shading) и **раскраска силами ИИ по MCP** — Claude или другой
клиент MCP изучает, заливает и снимает открытую модель. Ещё не сделано:

- ИИ, вторая волна: мазок кистью по точкам поверхности, отмена, выбор кисти и
  материала из библиотеки.
