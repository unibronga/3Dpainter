...
Открываете `.glb`, крутите модель и красите. Не нужно возиться с развёрткой,
...
Откройте `http://localhost:5273`. Программа стартует с демо-хижиной — красить
можно сразу, своя модель не нужна. Свою загружают кнопкой **«Открыть GLB…»**
или перетаскиванием `.glb` во вьюпорт.
...
стандартная упаковка, которую three.js читает напрямую).
...
- **Английский интерфейс.** Меню, панели и встроенная справка пока только на
  русском.
