...
- **Доперевести интерфейс.** Меню, начальный экран, сохранение и настройки
  переведены; боковые панели и окна кистей и материалов пока русские.
  Переключатель языка уже в **Файл ▸ Настройки…** и работает без потери
  покраски.
